...
class Flag {
  ...
  Flag(this.name, this.svgPaths, this.aspect);

  factory Flag.fromCca2(FlagCca2 cca2) {
    final info = flagsInfo[cca2.name.toLowerCase()];
    if (info == null) {
      throw Exception('No info found for ${cca2.name}');
    }
    final name = info['name'] as String;
    final svgPaths = info['paths'] as List<String>;
    final aspect = info['aspect'] as double;
    return Flag(name, svgPaths, aspect);
  }

  static const flagsInfo = {
    "af": {
      "name": "Afghanistan",
      "paths": [
    ...
    "bh": {
      "name": "Bahrain",
      "paths": ["assets/bahrain/bahrain_1.svg", "assets/bahrain/bahrain_2.svg"],
      "aspect": 1.67
    },
    "bd": {
      "name": "Bangladesh",
    ...
    "jp": {
      "name": "Japan",
      "paths": ["assets/japan/japan_1.svg", "assets/japan/japan_2.svg"],
      "aspect": 1.5
    },
    "jo": {
      "name": "Jordan",
    ...
    "qa": {
      "name": "Qatar",
      "paths": ["assets/qatar/qatar_1.svg", "assets/qatar/qatar_2.svg"],
      "aspect": 2.55
    },
    "sa": {
      "name": "Saudi Arabia",
    ...
    "tr": {
      "name": "Turkey",
      "paths": ["assets/turkey/turkey_1.svg", "assets/turkey/turkey_2.svg"],
      "aspect": 1.5
    },
    "tm": {
      "name": "Turkmenistan",
    ...
    "vn": {
      "name": "Vietnam",
      "paths": ["assets/vietnam/vietnam_1.svg", "assets/vietnam/vietnam_2.svg"],
      "aspect": 1.5
    },
    "ye": {
      "name": "Yemen",
    ...
    "al": {
      "name": "Albania",
      "paths": ["assets/albania/albania_1.svg", "assets/albania/albania_2.svg"],
      "aspect": 1.4
    },
    "ad": {
      "name": "Andorra",
    ...
    "dk": {
      "name": "Denmark",
      "paths": ["assets/denmark/denmark_1.svg", "assets/denmark/denmark_2.svg"],
      "aspect": 1.325
    },
    "ee": {
      "name": "Estonia",
    ...
    "fi": {
      "name": "Finland",
      "paths": ["assets/finland/finland_1.svg", "assets/finland/finland_2.svg"],
      "aspect": 1.64
    },
    "fr": {
      "name": "France",
    ...
    "gr": {
      "name": "Greece",
      "paths": ["assets/greece/greece_1.svg", "assets/greece/greece_2.svg"],
      "aspect": 1.5
    },
    "hu": {
      "name": "Hungary",
    ...
    "mc": {
      "name": "Monaco",
      "paths": ["assets/monaco/monaco_1.svg", "assets/monaco/monaco_2.svg"],
      "aspect": 1.5
    },
    "me": {
      "name": "Montenegro",
    ...
    "pl": {
      "name": "Poland",
      "paths": ["assets/poland/poland_1.svg", "assets/poland/poland_2.svg"],
      "aspect": 1.5
    },
    "pt": {
      "name": "Portugal",
    ...
    "se": {
      "name": "Sweden",
      "paths": ["assets/sweden/sweden_1.svg", "assets/sweden/sweden_2.svg"],
      "aspect": 1.6
    },
    "ch": {
      "name": "Switzerland",
    ...
    "ua": {
      "name": "Ukraine",
      "paths": ["assets/ukraine/ukraine_1.svg", "assets/ukraine/ukraine_2.svg"],
      "aspect": 1.5
    },
    "gb": {
      "name": "United Kingdom",
    ...
    "ma": {
      "name": "Morocco",
      "paths": ["assets/morocco/morocco_1.svg", "assets/morocco/morocco_2.svg"],
      "aspect": 1.5
    },
    "ao": {
      "name": "Angola",
    ...
    "so": {
      "name": "Somalia",
      "paths": ["assets/somalia/somalia_1.svg", "assets/somalia/somalia_2.svg"],
      "aspect": 1.5
    },
    "zw": {
      "name": "Zimbabwe",
    ...
    "tn": {
      "name": "Tunisia",
      "paths": ["assets/tunisia/tunisia_1.svg", "assets/tunisia/tunisia_2.svg"],
      "aspect": 1.5
    },
    "ss": {
      "name": "South Sudan",
    ...
    "pw": {
      "name": "Palau",
      "paths": ["assets/palau/palau_1.svg", "assets/palau/palau_2.svg"],
      "aspect": 1.6
    },
    "pg": {
